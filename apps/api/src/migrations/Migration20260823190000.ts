...
export class Migration20260823190000 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(
      `create table "platform_event_inbox" ("id" uuid not null, "aggregate_id" varchar(255) not null, "aggregate_version" int not null, "event_id" uuid not null, "event_type" varchar(255) not null, "organization_id" uuid not null, "processed_at" timestamptz null, "schema_version" int not null, "subscription_id" varchar(511) not null, primary key ("id"));`,
    )
    this.addSql(
